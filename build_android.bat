...
copy /y "android\app\build\outputs\apk\release\app-universal-release.apk" "android-releases\SpotDL_Android_Universal_v1.2.1.apk" >nul
copy /y "android\app\build\outputs\apk\release\app-arm64-v8a-release.apk" "android-releases\SpotDL_Android_ARM64.apk" >nul
copy /y "android\app\build\outputs\apk\release\app-arm64-v8a-release.apk" "android-releases\SpotDL_Android_ARM64_v1.2.1.apk" >nul
echo.
echo APK ready: android-releases\SpotDL_Android_ARM64_v1.2.1.apk
echo Universal fallback: android-releases\SpotDL_Android_Universal_v1.2.1.apk
endlocal
